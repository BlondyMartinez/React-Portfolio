...
const Resume = () => {
  const tech = [
    {
      ...
      bulletPoints: [
        ...
        "Development of game components.",
        "React + TypeScript.",
      ],
    },
    {
  ...
  const education = [
    ...
    },
    {
      ...
      bulletPoints: ["Best Programmer nominee at COMX 2019"],
    },
    {
  ...
  return (
    <div className="min-height d-flex flex-column justify-content-between align-items-center">
      <div className="mt-5">
        <a
          className="button d-inline-flex align-items-center gap-2 text-decoration-none"
          href="https://raw.githubusercontent.com/BlondyMartinez/React-Portfolio/master/src/pdf/Resume_BlondyMartinez.pdf"
          download
        >
          <Icon className="fs-3" icon="material-symbols-light:download" />{" "}
          Download Resume
        </a>
      </div>

      <div
        className="row m-2 flex-grow-1 d-flex justify-content-center align-items-center"
        style={{ height: "100%" }}
      >
      ...
      <h6 className="orange-text">
        *For extended work history check
        <a
          href="https://www.linkedin.com/in/blondy-martinez/"
          target="_blank"
          className="text-decoration-none light-blue-text"
        >
          {" "}
          LinkedIn
        </a>
