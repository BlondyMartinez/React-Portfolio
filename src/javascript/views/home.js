...
const Home = () => {
    ...
    return (
        <div className='d-flex flex-column align-items-center justify-content-center max-height overflow-hidden pt-5'>
            <img src={title} className='w-30 mb-3 opacity-80 pt-5 mt-5'></img>
